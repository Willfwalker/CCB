                        ...
                        <div className="space-y-12">
                            ...
                            <section>
                                ...
                                <div className="prose prose-lg text-earth/85 font-body-crimson max-w-none">
                                    <p>
                                        Worship with us on Sundays at <strong>2826 Birchwood Avenue</strong> at the following times:
                                    </p>
                                    <ul className="list-disc pl-5 my-4 space-y-2">
                                        <li><strong>9:00 am</strong></li>
                                        <li><strong>11:00 am</strong></li>
                                    </ul>
                                    <p>
                                    ...
                                    <p className="mt-4">
                                        <a href="https://christchurchbellingham.org/s/Sunday-March-1-2026.pdf" target="_blank" rel="noopener noreferrer" className="text-brand hover:underline font-semibold">
